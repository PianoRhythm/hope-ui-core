import { isArray, isObject, objectKeys, getLastItem, runIfFn, isNumber, delve, flatten, unflatten, pick, once, filterUndefined, isEmptyObject, pack } from '@hope-ui/utils';
export { pack } from '@hope-ui/utils';
import { createStitches } from '@stitches/core';
import { createComponent, Dynamic, mergeProps as mergeProps$1, useAssets, effect, template } from 'solid-js/web';
import { createContext, useContext, createMemo, mergeProps, splitProps } from 'solid-js';
...
const _tmpl$ = /*#__PURE__*/template(`<style id="stitches" $serveronly></style>`, 2);
...
function injectCriticalStyle() {
  ...
  useAssets(() => (() => {
    ...
    effect(() => _el$.innerHTML = getCssText());
    return _el$;
  })());
}
...
export { COLOR_MODE_CLASSNAMES, DEFAULT_THEME, DEFAULT_THEME_MAP, STYLE_CONFIG_PROP_NAMES, ThemeProvider, arrayToObjectNotation, computeStyleOptions, createGlobalStyles, createHopeComponent, createPalette, createStyleConfig, createStyles, extendTheme, fadeIn, focusStyles, getSelectedVariantClassNames, hope, injectCriticalStyle, isColorModeObjectLike, isResponsiveObjectLike, keyframes, mapResponsive, mergeThemeProps, objectToArrayNotation, resolveTokenValue, spin, useComponentTheme, useTheme };
