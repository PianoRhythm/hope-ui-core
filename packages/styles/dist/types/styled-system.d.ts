...
import { ThemeBreakpoint, ThemeFontFamily, ThemeFontSize, ThemeFontWeight, ThemeLetterSpacing, ThemeLineHeight, ThemeRadii, ThemeShadow, ThemeSize, ThemeSpace, ThemeZIndice } from "./scales";
import { ThemeVarsAndBreakpoints } from "./vars";
export interface SystemStyleColorModeValue<T> {
    light?: T;
    dark?: T;
}
declare type MaybeColorModeValue<T> = T | SystemStyleColorModeValue<T>;
export declare type ResponsiveArray<T> = Array<MaybeColorModeValue<T> | null>;
export declare type ResponsiveObject<T> = Partial<Record<ThemeBreakpoint | string, MaybeColorModeValue<T>>>;
declare type ResponsiveValueRaw<T> = MaybeColorModeValue<T> | ResponsiveArray<T> | ResponsiveObject<T>;
export declare type ResponsiveValue<T> = ResponsiveValueRaw<T> | ((theme: ThemeVarsAndBreakpoints) => ResponsiveValueRaw<T>);
export declare type ResponsiveProps<Props> = {
    [K in keyof Props]?: ResponsiveValue<Props[K]>;
};
export declare type SystemStyleBorderProps = ResponsiveProps<{
...
export declare type SystemStyleColorProps = ResponsiveProps<{
...
export declare type SystemStyleFlexboxProps = ResponsiveProps<{
    /**
...
export declare type SystemStyleGridProps = ResponsiveProps<{
    /**
...
export declare type SystemStyleLayoutProps = ResponsiveProps<{
...
export declare type SystemStyleInteractivityProps = ResponsiveProps<{
...
export declare type SystemStyleMarginProps = ResponsiveProps<{
...
export declare type SystemStylePaddingProps = ResponsiveProps<{
...
export declare type SystemStylePositionProps = ResponsiveProps<{
...
export declare type SystemStyleRadiiProps = ResponsiveProps<{
...
export declare type SystemStyleShadowProps = ResponsiveProps<{
...
export declare type SystemStyleSizeProps = ResponsiveProps<{
...
export declare type SystemStyleTypographyProps = ResponsiveProps<{
...
export declare type SystemStyleTransformProps = ResponsiveProps<{
...
export declare type SystemStyleTransitionProps = ResponsiveProps<{
...
export declare type SystemStyleOthersProps = ResponsiveProps<{
    /** The CSS `object-fit` property. */
    objectFit?: Stitches.CSS["objectFit"];
    /** The CSS `object-position` property. */
    objectPosition?: Stitches.CSS["objectPosition"];
}>;
export declare type BaseSystemStyleProps = SystemStyleBorderProps & SystemStyleColorProps & SystemStyleFlexboxProps & SystemStyleGridProps & SystemStyleInteractivityProps & SystemStyleLayoutProps & SystemStyleMarginProps & SystemStylePaddingProps & SystemStylePositionProps & SystemStyleRadiiProps & SystemStyleShadowProps & SystemStyleSizeProps & SystemStyleTransformProps & SystemStyleTransitionProps & SystemStyleTypographyProps & SystemStyleOthersProps;
export declare type BaseSystemStyleObject = OverrideProps<CSSObject, BaseSystemStyleProps>;
export declare type PseudoSelectorValue = BaseSystemStyleObject | ((theme: ThemeVarsAndBreakpoints) => BaseSystemStyleObject);
...
export declare type SystemStyleProps = BaseSystemStyleProps & PseudoSelectorProps;
export declare type SystemStyleObject = OverrideProps<CSSObject, SystemStyleProps>;
export declare type Sx = SystemStyleObject | ((theme: ThemeVarsAndBreakpoints) => SystemStyleObject);
