...
export declare type ThemeMap = Partial<Record<keyof CSSObject, keyof ThemeScales>>;
export declare type ComponentTheme<Props extends UseStyleConfigOptions<any, any> = {}, Keys extends keyof Props = never> = {
...
export declare type MaybeThemeWithMetaData = ThemeBase & Partial<ThemeMetaData>;
export interface Theme extends ThemeBase, ThemeMetaData {
}
export declare type ThemeOverride = DeepPartial<Omit<Theme, "components" | keyof ThemeMetaData>> & {
    components?: Record<string, ComponentTheme>;
};
