...
export declare type DefaultColorScheme = "primary" | "neutral" | "success" | "info" | "warning" | "danger";
/**
 ...
 * }
 */
export declare type ThemeColorScheme = DefaultColorScheme;
...
export declare type ThemePaletteRanges = Record<ThemeColorScheme, PaletteRange>;
 ...
 */
declare type ColorSystemStringUnion<K extends keyof ColorSystem> = ColorSystem[K] extends Record<string, any> ? Prefixed<`${K}.`, keyof ColorSystem[K]> : K;
/**
 ...
 * }
 */
export declare type ColorSystemTokenName = {
