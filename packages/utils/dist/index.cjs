 ...
 */function W(t){return typeof t=="number"}function u(t){return Array.isArray(t)}function w(t){return u(t)&&t.length===0}function d(t){return typeof t=="function"}function l(t){const n=typeof t;return t!=null&&(n==="object"||n==="function")&&!u(t)}function A(t){return l(t)&&Object.keys(t).length===0}function F(t){return t==null}function h(t){return Object.prototype.toString.call(t)==="[object String]"}function H(t){return u(t)?w(t):l(t)?A(t):t==null||t===""}/*!
 * Original code by Chakra UI
 * MIT Licensed, Copyright (c) 2019 Segun Adebayo.
 *
 * Credits to the Chakra UI team:
 * https://github.com/chakra-ui/chakra-ui/blob/main/packages/utils/src/array.ts
 */function V(t){const n=t==null?0:t.length;return n?t[n-1]:void 0}function x(t){return t==null?[]:u(t)?t:[t]}/*!
 ...
 */function J(t){if(Q())t.focus({preventScroll:!0});else{const n=K(t);t.focus(),v(n)}}let f=null;function Q(){if(f==null){f=!1;try{document.createElement("div").focus({get preventScroll(){return f=!0,!0}})}catch{}}return f}function K(t){let n=t.parentNode;const e=[],r=document.scrollingElement||document.documentElement;for(;n instanceof HTMLElement&&n!==r;)(n.offsetHeight<n.scrollHeight||n.offsetWidth<n.scrollWidth)&&e.push({element:n,scrollTop:n.scrollTop,scrollLeft:n.scrollLeft}),n=n.parentNode;return r instanceof HTMLElement&&e.push({element:r,scrollTop:r.scrollTop,scrollLeft:r.scrollLeft}),e}function v(t){for(const{element:n,scrollTop:e,scrollLeft:r}of t)n.scrollTop=e,n.scrollLeft=r}/*!
 * Portions of this file are based on code from chakra-ui.
 * MIT Licensed, Copyright (c) 2019 Segun Adebayo.
 *
 * Credits to the Chakra UI team:
 * https://github.com/chakra-ui/chakra-ui/blob/main/packages/utils/src/function.ts
 */function tt(){}function nt(t,n){return t&&(d(t)?t(n):t[0](t[1],n)),n==null?void 0:n.defaultPrevented}function et(t,...n){return d(t)?t(...n):t}function rt(t){let n=!1;return function(...e){n||(n=!0,t(...e))}}function P(t,n,e=1/0){return!l(t)&&!Array.isArray(t)||!e?t:Object.entries(t).reduce((r,[o,i])=>(l(i)||u(i)?Object.entries(P(i,n,e-1)).forEach(([c,s])=>{r[`${o}${n}${c}`]=s}):r[o]=i,r),{})}function ot(t,n){return Object.keys(t).reduce((e,r)=>(r.split(n).reduce((o,i,c,s)=>(o[i]!=null||(o[i]=s.length-1===c?t[r]:{}),o[i]),e),e),{})}function it(t,n){return n.split(".").reduce((e,r)=>e&&e[r],t)}/*!
 * Original code by Chakra UI
 * MIT Licensed, Copyright (c) 2019 Segun Adebayo.
 *
 * Credits to the Chakra UI team:
