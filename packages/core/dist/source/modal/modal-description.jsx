 ...
 */
export const ModalDescription = createHopeComponent(props => {
    ...
    return (<hope.p id={modalContext.descriptionId()} class={clsx(modalContext.baseClasses().description, local.class)} __css={modalContext.styleOverrides().description} {...others}/>);
});
