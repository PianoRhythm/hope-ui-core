...
export interface ModalProps extends BaseModalProps, Omit<ModalStyleConfigProps, keyof HopeProps>, ParentProps {
}
export declare type ModalThemeProps = "contentTransitionOptions" | "overlayTransitionOptions" | "closeOnOverlayClick" | "closeOnEsc" | "preventScroll" | "trapFocus" | "initialFocusSelector" | "restoreFocusSelector";
export declare type ModalTheme = ComponentTheme<ModalProps, ModalThemeProps>;
