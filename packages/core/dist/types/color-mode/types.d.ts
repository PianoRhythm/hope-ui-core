...
export declare type ConfigColorMode = ColorMode | "system";
export declare type MaybeConfigColorMode = ConfigColorMode | undefined;
...
export declare type ColorModeProviderProps = ParentProps<ColorModeOptions>;
