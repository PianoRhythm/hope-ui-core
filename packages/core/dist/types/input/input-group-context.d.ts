...
export declare const InputGroupContext: import("solid-js").Context<InputGroupContextValue>;
export declare function useInputGroupContext(): InputGroupContextValue;
export declare function useRequiredInputGroupContext(): InputGroupContextValue;
