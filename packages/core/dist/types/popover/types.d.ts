...
declare type PopoverTriggerMode = "hover" | "click";
export declare type AnchorRect = {
    x?: number;
    y?: number;
    width?: number;
    height?: number;
};
export declare type PopoverChildrenRenderProp = (props: {
...
export declare type PopoverTheme = ComponentTheme<PopoverProps, "transitionOptions" | "triggerMode" | "placement" | "offset" | "arrowPadding" | "overflowPadding" | "openDelay" | "closeDelay" | "closeOnBlur" | "closeOnEsc" | "trapFocus" | "initialFocusSelector" | "restoreFocusSelector">;
